...
<main class="cmp640">
        ...
        <div class="pt-15 pb-5 zi-hui overflow-hidden">
            <font size="2">
                <div class="txt-l col-6">
                   入住时间：<i><fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${entity.createdate}'/></i>
                </div>
    ...
    <div class="div-group-10">
        ...
        <div class="pt-15 pb-5 line-height25 zi-hui overflow-hidden">
            <font size="2">
                <div><i class="zi-hei">学历：</i>${entity.record}</div> 
                <div><i class="zi-hei">工作经验：</i>${entity.experience}</div>
                <div><i class="zi-hei">期望岗位：</i>${entity.title}</div>
                <div><i class="zi-hei">期望工作地点：</i>${entity.workaddress}</div> 
            </font>
        </div>
    </div>
    <div class="hang7 overflow-hidden bg-hui clear"></div>
        ...
        <div class="zi-hei overflow-hidden">
            <font size="3">
                ...
                <div class="hang40">
                    ...
                    <div class="pull-right pt-2" onclick="window.location.href='tel:${entity.tel}'">
                        <div class="clear img-wh35 btn-green txt-c border-radius50">
    ...
    <font size="2">
        <div class="div-group-5 pt-10 pb-10 line-bottom">
            <div class="line-left-green"><i class="pl-10">个人描述</i></div>
        </div>
