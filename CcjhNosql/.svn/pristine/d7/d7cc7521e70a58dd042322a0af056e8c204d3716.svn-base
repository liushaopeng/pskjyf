...
<main class="cmp640">
    ...
    <div class="div-group-10">
        ...
        <div class="pt-15 pb-5 line-height30 zi-hui overflow-hidden">
            <font size="2">
                <div><i class="zi-hei">户型：</i>${entity.type}</div>
                <div><i class="zi-hei">面积：</i>${entity.big}</div>
                <div><i class="zi-hei">房龄：</i>${entity.age}</div>
                <div><i class="zi-hei">装修：</i>${entity.decorate}</div>
                <div><i class="zi-hei">规格：</i>${entity.standard}</div>
                <div><i class="zi-hei">楼层：</i>${entity.floor}</div> 
            </font>
        </div>
    </div>
    <div class="hang7 overflow-hidden bg-hui clear"></div>
