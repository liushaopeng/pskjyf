      ...
      <div class="breadcrumb-wrapper1">
        <div class="input-group ">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
            	<li><a  href="javascript:share('${ctxurl}/suc/comunit!webIndex.action?custid=${entity._id}')"><i class="fa fa-share-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;单点分享</a></li>
            	
            	<li><a href="${contextPath}/suc/comunit!fabu.action?"><i class="fa fa-share-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;发布</a></li>
            
            	<c:if test='${entity.qx==1}'><li><a href="javascript:addwxpay();"><i class="fa fa-calculator"></i>&nbsp;&nbsp;&nbsp;&nbsp;结算设置</a></li></c:if>
            </ul>
         </div>
      </div>
    </div>
							...
							<td class="table-action">
                              ...
                              <div class="btn-group1">
                                  ...
                                  <ul role="menu" class="dropdown-menu pull-right">
                                      ...
                                      <li><a href="${contextPath}/rf/fromuseradmin.action?wid=${bean.type}"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;&nbsp;管理员</a></li>
                                      <li><a href="${contextPath}/news/advertisement.action?cate_id=5555&type=${bean.key}"><i class="fa fa-bullhorn"></i>&nbsp;&nbsp;&nbsp;&nbsp;广告管理</a></li>
                                  </ul>
                              </div>
                          </td>
						</tr>
