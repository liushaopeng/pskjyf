                            ...
                            <table class="table table-striped table-primary table-action mb30">
                                ...
                                <c:forEach items="${list}" var="bean">
                                    <tr class="table-action">
                                        ...
                                        <td><fmt:formatNumber value='${bean.obj.lowprice}' pattern="0.0#"/></td>
                                        <td><fmt:formatNumber value='${bean.obj.price}' pattern="0.0#"/></td>
                                        ...
                                        <td class="table-action">
                                            ...
                                            <div class="btn-group1">
                                                ...
                                                <ul role="menu" class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a href="${contextPath}/suc/activity!detail.action?id=${bean._id}">
