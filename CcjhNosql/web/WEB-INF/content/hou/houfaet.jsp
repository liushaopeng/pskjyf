...
function del(id) {
	if (confirm('确实要删除吗?')) {
		location.href = "${contextPath}/hou/houfaet!delete.action?_id="
				+ id+"&fypage=${fypage}";
	}
}
function add() {
...
function upd(id){
	...
	$.post('${ctx}/hou/houfaet!upd.action', submitData,
		function(json) {
			$('#_id').val(json._id);
...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/hou/houfaet.action?" >
    
    <div class="pageheader">
      
      <h2><i class="fa fa-user"></i> 微家政 <span>优势管理</h2>
    ...
    <div style="padding-top:2%">
        <div class="pl-10 pr-10 maring-a cmp500"
            ...
            <div class=" bg-bai border-radius3 overflow-hidden">
                ...
                <form id="inscxForm" action="${ctx}/suc/houfaet!save.action?fypage=${fypage}"
