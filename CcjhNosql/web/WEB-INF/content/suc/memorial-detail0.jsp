...
<main class="cmp640 lock">
    <c:if test="${fn:length(lsdead)==1}">
        <div class="position-r">
            <img src="${ctx}/img/memorial_bg.jpg" class="width-10">
            ...
            <div class="width-10 position-a position-r" style="top: 22%;">
                <div class="maring-a position-r div-group-2" style="width: 26%;z-index: 10;">
                    <c:forEach items="${lsdead}" var="bean">
                        <c:if test="${not empty bean.picurl}">
                            <img src="${filehttp}/${bean.picurl}" class="width-10">
                            <img src="${ctx}/img/memorial_xk.png" class="position-a width-10"
    ...
    <c:if test="${fn:length(lsdead)==2}">
        <div class="position-r">
            <img src="${ctx}/img/memorial_bg.jpg" class="width-10">

            <div class="width-10 position-a position-r" style="top: 25%;">
                <div class="width-5 maring-a">
                    <c:forEach items="${lsdead}" var="bean" begin="0" end="0">
                        <c:if test="${not empty bean.picurl}">
                            <div class="position-r pull-left div-group-2" style="width:48%;z-index: 10;">
                                <img src="${filehttp}/${bean.picurl}" class="width-10">
                                <img src="${ctx}/img/memorial_xk.png" class="position-a width-10"
                                     style="top: 0px; left:0px; z-index: 1;">
                            </div>
                    ...
                    <div class="position-r pull-left" style="width:4%;height:10px;"></div>
                    <c:forEach items="${lsdead}" var="bean" begin="1" end="1">
                        <c:if test="${not empty bean.picurl}">
                            <div class="position-r pull-left div-group-2" style="width:48%;z-index: 10;">
                                <img src="${filehttp}/${bean.picurl}" class="width-10">
                                <img src="${ctx}/img/memorial_xk.png" class="position-a width-10"
    ...
    <div class="hang40 line-height40 pl-10 pr-10 bg-hei-8 zi-bai clear">
        ...
        <div class="pull-right">馆主：<i>${entity.nickname}</i></div>
    </div>
        ...
        <font size="2">
                ...
                <c:if test="${fn:length(lsdead)==2}">
                    <c:forEach items="${lsdead}" var="bean" begin="0" end="0">
                        <div class="pt-10" id="dead_name1" onclick="changedead(this)">
                            <div class="width-4 maring-a hang30 txt-c border-radius3 line-lu zi-3a line-height32">
            ...
            <c:forEach items="${lsdead}" var="bean" begin="0" end="0">
                <div class="clear div-group-10" id="dead1">
                    <div class="width-2 maring-a pt-15">
                        <c:if test="${empty bean.picurl}">
                            <img src="${ctx}/img/memorial_sz.jpg" class="width-10">
                        </c:if>
                        <c:if test="${not empty bean.picurl}">
            ...
            <c:forEach items="${lsdead}" var="bean" begin="1" end="1">
                <div class="clear div-group-10 display-none" id="dead2">
                    <div class="width-2 maring-a pt-15">
                        <c:if test="${empty bean.picurl}">
                            <img src="${ctx}/img/memorial_sz.jpg" class="width-10">
                        </c:if>
