...
<script type="text/javascript">
	...
	function del(id) {
		if (confirm('确实要删除吗?')) {
			location.href = "${ctx}/suc/mark!delete.action?fypage=${fypage}&_id=" + id;
		}
	}
	function add(){
	$('#_id').val('');
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				...
				<div class="pageheader">
					<h2>
						<i class="fa fa-user"></i> 微官网 <span>纪念馆管理</span>
					</h2>
					<div class="breadcrumb-wrapper1">
						<div class="input-group ">
            	           ...
            	           <li><a href="javascript:add();"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;&nbsp;添加纪念馆</a></li> 
                           </ul>
                        </div> 	
					</div>
				</div>
												...
												<td class="table-action">
													<div class="btn-group1">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<li><a href="${ctx}/suc/mark!comment.action?id=${bean._id}"><i
																	class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;评论管理</a>
															</li>
														</ul>
													</div></td>
											</tr>
    ...
    <div style="padding-top:2%">
        <div class="pl-10 pr-10 maring-a cmp500"
            ...
            <div class=" bg-bai border-radius3 overflow-hidden">
                ...
                <form id="inscxForm" action="${ctx }/suc/mark!save.action?fypage=${fypage}"
