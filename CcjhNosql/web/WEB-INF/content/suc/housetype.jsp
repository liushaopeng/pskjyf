    ...
    <script type="text/javascript">
        ...
        function del(id) {
            if (confirm('确实要删除吗?')) {
                ...
                location.href = "${contextPath}/suc/housetype!delete.action?_id="
                + id;
        ...
        function upd(id) {
            ...
            $.post('${ctx}/suc/housetype!upd.action', submitData, function (json) {
                $('#_id').val(json._id);
...
<section>
    ...
    <div class="mainpanel">
        ...
        <form id="custinfoForm" name="custinfoForm" method="post" action="${contextPath}/suc/housetype.action?">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped table-primary table-action mb30">
                                ...
                                <tbody>
                                <c:forEach items="${comunittypeList}" var="bean">
                                    <tr>
                                        <td>${bean.sort}</td>
                                        <td>${bean.title}</td>
    ...
    <div style="padding-top:2%">
        <div class="pl-10 pr-10 maring-a cmp500"
            ...
            <div class=" bg-bai border-radius3 overflow-hidden">
                ...
                <form id="inscxForm" action="${ctx}/suc/housetype!save.action?fypage=${fypage}"
