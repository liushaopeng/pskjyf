...
function del(id) {
	if(confirm('确实要删除吗?')) {
		location.href = "${ctx}/suc/exceptional!delete.action?_id="+ id;
	}		
}
function add(){
     
		location.href ="${ctx}/suc/exceptional!input.action";
}
function upd(id){
   var submitData = {
		id : id
	};
	$.post('${ctx}/suc/exceptional!upd.action', submitData, function(json) {
		$('#_id').val(json._id);
...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/exceptional.action" >
    
    <div class="pageheader">
      
      <h2><i class="fa fa-user"></i>网站管理 <span>打赏管理</span></h2>
		...
		<div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-primary mb30" >
                    ...
                    <tbody>
                      <c:forEach items="${exceptionalList}" var="bean">
                      <tr> 
