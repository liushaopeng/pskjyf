...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/bbsstick.action" >
            ...
            <div class="table-responsive">
                <table class="table table-primary mb30" >
                    ...
                    <tbody>
                      ...
                      <tr> 
                        <td><img src="${filehttp }/${bean.user.headimgurl}" height="25px"/></td>
                      	<td>${bean.user.nickname}</td>
                      	
                      	<td>${bean.content}</td> 
                      	<td>
                      	<c:if test="${not empty bean.createdate}">
                      	...
                      	<c:if test="${empty bean.enddate}"><td>未开始</td></c:if>
                      	<td>${bean.time}</td>
                      	<td>${bean.state}</td>
                              ...
                              <div class="btn-group1">
                                  ...
                                  <ul role="menu" class="dropdown-menu pull-right">  
                                      <li><a href="javascript:audit('${bean._id}');">
                                      		<i class="fa fa-calendar-check-o"></i>&nbsp;&nbsp;&nbsp;&nbsp;通过审核</a></li>
