...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/mobilescene.action" >
      ...
      <div class="breadcrumb-wrapper1">
        <div class="input-group ">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
            	...
            	<li><a href="${contextPath}/suc/mobilescene!getAll.action"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;&nbsp;模板库</a></li> 
