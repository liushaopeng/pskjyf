...
<main class="cmp640">
    ...
    <div class="hang10 overflow-hidden bg-hui clear"></div>

    <div class="div-group-10">
         
        <div class="pt-15 pb-5 line-height25 zi-hui overflow-hidden">
            <font size="2">
                <div><i class="zi-hei">公司福利：</i>${entity.welfare}</div> 
    ...
    <div class="div-group-10">
        <div class="zi-hei overflow-hidden">
            <font size="3">
                <div class="hang40 line-height40">联系人：${entity.linkman}</div>
                <div class="hang40">
    ...
    <font size="2">
        <div class="div-group-5 pt-10 pb-10 line-bottom">
            <div class="line-left-green"><i class="pl-10">描述</i></div>
        </div>
