 ...
 */
@Namespace("/hou")
@Results({ @Result(name = HouproAction.RELOAD, location = "houpro.action", params = {"fypage", "%{fypage}" }, type = "redirect") })
public class HouproAction extends GeneralAction<HousewiferyProcess> {
	private static final long serialVersionUID = -6784469775589971579L;
	@Autowired
	private BaseDao baseDao;
	private HousewiferyProcess entity = new HousewiferyProcess();
	private Long _id;
	...
	public String update() throws Exception { 
		...
		entity = JSON.parseObject(db.toString(), HousewiferyProcess.class);
	...
	@Override
	public HousewiferyProcess getModel() {
		return entity;
	}
